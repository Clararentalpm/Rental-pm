...
assert(html.includes('McGregor and Carindale tenants stay on their own property tab')||html.includes('Current = active occupancy today')||html.includes('Historical / Archive is separate for audit')||html.includes('operational tabs are'),'tenants page scoped copy');
